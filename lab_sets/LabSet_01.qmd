...
> Your response: Reliability can be increase with cross-validation (this would also improve generalizability)
...
> Your response: I took a data mining course that briefly covered text analysis and it made me interested in learning more about the topic. I am interested in how this sort of analysis could be applied in my social psychology research (namely how effective experimental techniques of having participants engage in writing exercises are when the participants' text is used as a unit of analysis)
...
> Your response: I would pick their decision of binning their variables and use some form of validation to check how it was affecting their findings.
...
> Your response:  chosen tokens, over-training model, sample size, and threshold set for validation.
